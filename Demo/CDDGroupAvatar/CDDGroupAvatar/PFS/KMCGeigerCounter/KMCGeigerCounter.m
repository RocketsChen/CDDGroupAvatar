...
#define isXDevice  (([[UIScreen mainScreen] respondsToSelector:@selector(nativeBounds)] ? [UIScreen mainScreen].nativeBounds.size.height/[UIScreen mainScreen].nativeScale : [UIScreen mainScreen].bounds.size.height) > 800.0)
...
- (void)enable
{
    ...
    CGFloat meterHeight = 20;
    self.meterLabel = [[UILabel alloc] initWithFrame:CGRectMake(xOrigin, isXDevice ? 35.0 : 5.0,
